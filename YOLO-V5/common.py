...
#         self.act = nn.SiLU()
#         if use_se:
#             self.se = SEBlock(c_out, internal_neurons=c_out // 16)
#         else:
#             self.se = nn.Identity()
#
#         if deploy:
#             self.rbr_reparam = nn.Conv2d(c_in, c_out, kernel_size=kernel_size,
